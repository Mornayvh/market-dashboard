...
direct_svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200"><rect width="400" height="200" fill="#F8FAFC"/><rect x="15" y="15" width="160" height="55" rx="4" fill="#FFFFFF" stroke="#E2E8F0"/><rect x="25" y="25" width="60" height="4" rx="1" fill="#1E293B"/><rect x="25" y="35" width="100" height="3" rx="1" fill="#E2E8F0"/><rect x="25" y="44" width="80" height="3" rx="1" fill="#16A34A" opacity="0.5"/><rect x="25" y="53" width="65" height="3" rx="1" fill="#DC2626" opacity="0.4"/><rect x="225" y="15" width="160" height="55" rx="4" fill="#FFFFFF" stroke="#2563EB" stroke-width="1.5"/><rect x="235" y="25" width="70" height="4" rx="1" fill="#1E293B"/><rect x="235" y="35" width="90" height="3" rx="1" fill="#E2E8F0"/><rect x="235" y="44" width="100" height="3" rx="1" fill="#16A34A" opacity="0.6"/><rect x="235" y="53" width="55" height="3" rx="1" fill="#16A34A" opacity="0.4"/><polyline points="20,170 60,160 100,155 140,140 180,148 220,128 260,118 300,112 340,98 380,90" fill="none" stroke="#2563EB" stroke-width="2"/><polyline points="20,175 60,170 100,166 140,160 180,162 220,152 260,148 300,142 340,135 380,130" fill="none" stroke="#94A3B8" stroke-width="1" opacity="0.5"/><polyline points="20,178 60,174 100,172 140,168 180,170 220,164 260,160 300,158 340,154 380,150" fill="none" stroke="#94A3B8" stroke-width="1" opacity="0.5"/></svg>'
direct_b64 = base64.b64encode(direct_svg.encode()).decode()

altmgr_svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200"><rect width="400" height="200" fill="#F8FAFC"/><rect x="15" y="14" width="370" height="5" rx="2" fill="#CBD5E1"/><rect x="15" y="28" width="70" height="4" rx="1" fill="#E2E8F0"/><rect x="120" y="28" width="40" height="4" rx="1" fill="#2563EB" opacity="0.6"/><rect x="190" y="28" width="35" height="4" rx="1" fill="#16A34A" opacity="0.5"/><rect x="260" y="28" width="40" height="4" rx="1" fill="#DC2626" opacity="0.4"/><rect x="320" y="28" width="50" height="4" rx="1" fill="#16A34A" opacity="0.4"/><rect x="15" y="40" width="70" height="4" rx="1" fill="#E2E8F0"/><rect x="120" y="40" width="40" height="4" rx="1" fill="#2563EB" opacity="0.6"/><rect x="190" y="40" width="35" height="4" rx="1" fill="#DC2626" opacity="0.5"/><rect x="260" y="40" width="40" height="4" rx="1" fill="#16A34A" opacity="0.4"/><rect x="320" y="40" width="50" height="4" rx="1" fill="#16A34A" opacity="0.4"/><rect x="15" y="52" width="70" height="4" rx="1" fill="#E2E8F0"/><rect x="120" y="52" width="40" height="4" rx="1" fill="#2563EB" opacity="0.6"/><rect x="190" y="52" width="35" height="4" rx="1" fill="#16A34A" opacity="0.5"/><rect x="260" y="52" width="40" height="4" rx="1" fill="#DC2626" opacity="0.4"/><rect x="320" y="52" width="50" height="4" rx="1" fill="#DC2626" opacity="0.4"/><polyline points="20,180 60,165 100,168 140,150 180,155 220,135 260,138 300,120 340,110 380,100" fill="none" stroke="#2563EB" stroke-width="2"/><polyline points="20,185 60,178 100,180 140,170 180,172 220,162 260,165 300,158 340,150 380,145" fill="none" stroke="#16A34A" stroke-width="1.4" opacity="0.6"/><polyline points="20,188 60,184 100,182 140,180 180,178 220,176 260,172 300,170 340,168 380,164" fill="none" stroke="#94A3B8" stroke-width="1" opacity="0.5"/></svg>'
